...
import { Leaf, Dumbbell, PersonStanding, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Leaf key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <PersonStanding key={3} />],
