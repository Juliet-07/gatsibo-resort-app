...
const accommodations: AccommodationProps[] = [
  {
    ...
    location: "Lakeside",
    features: ["Wi-Fi", "Kitchen", "Bathroom", "Air Conditioning", "TV", "Balcony", "Garden View"]
  },
  {
    id: "2",
    ...
    features: ["Wi-Fi", "Kitchenette", "Bathroom", "Air Conditioning", "TV", "Traditional Decor"]
  },
  {
    id: "3",
    name: "Garden Rooms",
    ...
    features: ["Wi-Fi", "Bathroom", "Air Conditioning", "TV", "Garden View", "Natural Materials"]
  }
];
