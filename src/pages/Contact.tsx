  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-20">
        ...
        <section id="contact-hero" className="relative h-[500px] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-black/50 z-10"></div>
            <img className="absolute inset-0 w-full h-full object-cover" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/f676db2a01-f381d9aa64bb34391e93.png" alt="Rwanda resort contact reception area, traditional Rwandan architecture, welcoming entrance with cultural elements" />
