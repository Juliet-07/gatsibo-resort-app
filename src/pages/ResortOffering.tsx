...
export default function ResortDetails() {
  ...
  const [filteredAccommodations, setFilteredAccommodations] =
    useState<AccommodationProps[]>(allAccommodations);
  ...
  const locations = [
    "all",
    ...new Set(allAccommodations.map((acc) => acc.location)),
  ];
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-20">
          ...
          <div className="relative z-20 h-full flex items-center justify-center text-center px-5">
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Discover accommodations that blend modern comfort with authentic
                Rwandan tradition
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Whether you're traveling solo, as a couple, or with a group, our
                rooms are designed for rest and connection.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
              ...
              <div>
                ...
                >
                  <SelectTrigger className="w-full">
                    <SelectValue
                      placeholder={t.accommodations.filters.guests}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t.accommodations.filters.anyGuests}
                    </SelectItem>
                    <SelectItem value="1">
                      {t.accommodations.filters.onePlus}
                    </SelectItem>
                    <SelectItem value="2">
                      {t.accommodations.filters.twoPlus}
                    </SelectItem>
                    <SelectItem value="3">
                      {t.accommodations.filters.threePlus}
                    </SelectItem>
                    <SelectItem value="4">
                      {t.accommodations.filters.fourPlus}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                ...
                >
                  <SelectTrigger className="w-full">
                    <SelectValue
                      placeholder={t.accommodations.filters.location}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t.accommodations.filters.allLocations}
                    </SelectItem>
                    {locations
                      .filter((loc) => loc !== "all")
                      .map((location) => (
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  ...
                  {priceRange[0].toLocaleString()} RWF -{" "}
            ...
            <div className="flex justify-between items-center mt-6 animate-fade-in [animation-delay:200ms]">
              <p className="text-muted-foreground">
                {t.accommodations.filters.showing}{" "}
                {filteredAccommodations.length} {t.accommodations.filters.of}{" "}
                {allAccommodations.length}{" "}
                {t.accommodations.filters.accommodations}
              </p>
              <Button
                variant="outline"
                onClick={() => {
            ...
            {filteredAccommodations.length > 0 ? (
              ...
              <div className="text-center py-12 animate-fade-in">
                <h3 className="text-xl font-semibold mb-2">
                  {t.accommodations.filters.noMatch}
                </h3>
                <p className="text-muted-foreground mb-6">
                  {t.accommodations.filters.adjustFilters}
                </p>
                <Button
                  variant="outline"
                  onClick={() => {
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-white/90 text-lg mb-8">
                  Savor Rwandan flavors under the open sky with our
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">
                        Fresh, locally sourced ingredients prepared with
                        traditional Rwandan recipes and modern culinary
                        techniques.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white mb-2">
                        Outdoor Lounges & Fire Pits
                      </h4>
                      <p className="text-white/80">
                        Gather around crackling fires under starlit skies,
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">
                        Explore beautiful gardens and lakeside paths that
                        showcase Rwanda's natural beauty.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <img
                  ...
                  src="https://storage.googleapis.com/uxpilot-auth.appspot.com/efb1bf0d76-084926c35ef551cd6068.png"
                  alt="outdoor dining Rwanda resort, traditional food presentation, lakeside restaurant, fire pit evening"
                />
                <img
                  className="w-full h-[200px] object-cover rounded-lg"
                  src="https://storage.googleapis.com/uxpilot-auth.appspot.com/d8bee460be-762cb7604f281939078f.png"
                  alt="scenic walking trail Rwanda resort, lush gardens, peaceful pathway, mountain views"
                />
                <img
                  className="w-full h-[200px] object-cover rounded-lg"
                  src="https://storage.googleapis.com/uxpilot-auth.appspot.com/369c532eb8-0359972602f9f785de29.png"
                  alt="outdoor lounge area Rwanda resort, comfortable seating, fire pit, evening atmosphere"
                />
                <img
                  className="w-full h-[200px] object-cover rounded-lg"
                  src="https://storage.googleapis.com/uxpilot-auth.appspot.com/544023883d-7f7631313bb6d6a9603d.png"
                  alt="farm to table dining Rwanda, fresh local ingredients, traditional cooking, outdoor kitchen"
                />
              </div>
            </div>
          </div>
        ...
        <section id="recreation" className="py-20 px-5 bg-white">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Discover spaces designed for every mood - from active recreation
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  Peaceful spaces for meditation, reading, and personal
                  reflection.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  Spacious areas perfect for family reunions and group
                  celebrations.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  Inspiring environments for artists, writers, and creative
                  minds.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  Rejuvenating activities to restore mind, body, and spirit.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Yoga sessions</li>
                  <li>• Nature walks</li>
          ...
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-white/80 text-sm">
                  24/7 guest services and assistance
                </p>
              </div>
        ...
        <section id="booking-cta" className="py-20 px-5 bg-white">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="font-bold text-3xl md:text-4xl text-black mb-6">
              Ready to Experience Authentic Rwanda?
            </h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Book your stay at our resort where culture meets comfort, and
