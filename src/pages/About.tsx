    ...
    <>
      ...
      >
        ...
        <img
          ...
          src="https://storage.googleapis.com/uxpilot-auth.appspot.com/3c90bc2119-359cff4309b7c886be57.png"
          alt="Traditional Rwandan cultural ceremony with elders, community gathering, traditional architecture, vibrant cultural patterns"
        />
        <div className="relative z-20 h-full flex items-center justify-center text-center px-5">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
              Preserving traditions, empowering communities, and sharing the
              authentic spirit of Rwanda
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-dusky text-lg mb-6 leading-relaxed">
                Founded by passionate custodians of Rwandan culture, our center
                began as a vision to preserve and celebrate tradition while
                empowering the local community. Every stone, every story, every
                song carries the weight of generations.
              </p>
              <p className="text-dusky text-lg mb-8 leading-relaxed">
                We are more than a cultural center—we are guardians of memory,
                keepers of wisdom, and bridges between the past and future of
                Rwanda.
              </p>
            ...
            <div className="relative">
              <img
                ...
                src="https://storage.googleapis.com/uxpilot-auth.appspot.com/688a8bc2ac-6eec00aed853e6569ac6.png"
                alt="Rwandan cultural founders, community elders teaching traditional crafts, intergenerational knowledge transfer"
              />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-dusky text-lg max-w-3xl mx-auto">
              Learn about age-old practices passed down through generations,
              each one a thread in the rich tapestry of Rwandan culture
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div
              id="intore-dance"
              className="bg-white p-8 rounded-xl border border-dusky/20 hover:shadow-lg transition-all"
            >
              ...
              <img
                ...
                src="https://storage.googleapis.com/uxpilot-auth.appspot.com/f496210ca1-95aa3762fb1d4021f06b.png"
                alt="Traditional Rwandan Intore dancers in colorful feathered headdresses, dynamic dance performance, traditional drums"
              />
              <p className="text-dusky mb-4">
                Experience the powerful rhythms and graceful movements of
                Rwanda's most celebrated traditional dance form.
              </p>
              <ul className="text-dusky text-sm space-y-2">
                <li className="flex items-center">
                  <Check className="text-rainforest mr-2" />
            ...
            >
              ...
              <img
                className="w-full h-48 object-cover rounded-lg mb-4"
                src="https://storage.googleapis.com/uxpilot-auth.appspot.com/9a4349e010-f2ee1895799d0bbd3cc7.png"
                alt="Rwandan artisans weaving traditional baskets, pottery making, intricate basket patterns, clay pottery"
              />
              <p className="text-dusky mb-4">
                Master the ancient arts of basket weaving and pottery under the
                guidance of skilled local artisans.
              </p>
              <ul className="text-dusky text-sm space-y-2">
                <li className="flex items-center">
                  <Check className="text-rainforest mr-2" />
            ...
            >
              ...
              <img
                className="w-full h-48 object-cover rounded-lg mb-4"
                src="https://storage.googleapis.com/uxpilot-auth.appspot.com/c5daf90944-19497edd5fac29735d90.png"
                alt="Community gathering around fire at night, elder telling stories under stars, traditional storytelling circle"
              />
              <p className="text-dusky mb-4">
                Gather under starlit skies for enchanting tales that have shaped
                Rwandan culture for centuries.
              </p>
              <ul className="text-dusky text-sm space-y-2">
                <li className="flex items-center">
                  <Check className="text-rainforest mr-2" />
                  Weekly storytelling circles
                </li>
                <li className="flex items-center">
                  <Check className="text-rainforest mr-2" />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-white/90 text-lg max-w-3xl mx-auto">
              Immerse yourself in authentic cultural experiences that support
              and celebrate our local community
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-white/90 mb-4">
                Participate in hands-on learning experiences with master
                craftspeople and cultural keepers.
              </p>
            ...
            >
              ...
              <p className="text-white/90 mb-4">
                Join guided tours through local villages and learn about daily
                life and traditions firsthand.
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-white/80 text-sm">
                  <Clock className="mr-2" />
            ...
            >
              ...
              <p className="text-white/90 mb-4">
                Purchase authentic handmade crafts directly from local makers
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-dusky text-lg">
              Discover the milestones that shaped our cultural center and
              community
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div id="timeline-1" className="relative flex items-center mb-12">
              <div className="w-1/2 pr-8 text-right">
                ...
                <p className="text-dusky">
                  Local elders establish the first cultural preservation
                  initiative to safeguard traditional practices.
                </p>
              </div>
            ...
            <div id="timeline-2" className="relative flex items-center mb-12">
              ...
              <div className="w-1/2 pl-8">
                ...
                <p className="text-dusky">
                  Expansion of programs to include youth education and
            ...
            <div id="timeline-3" className="relative flex items-center mb-12">
              <div className="w-1/2 pr-8 text-right">
                <h3 className="font-semibold text-xl text-black mb-2">
                  2010s - Resort Integration
                </h3>
                <p className="text-dusky">
                  Launch of the resort component, creating sustainable tourism
            ...
            <div id="timeline-4" className="relative flex items-center">
              ...
              <div className="w-1/2 pl-8">
                ...
                <p className="text-dusky">
                  A thriving center where tradition meets innovation, preserving
                  culture while embracing the future.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="cultural-impact" className="py-20 px-5 bg-cream">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-dusky text-lg max-w-3xl mx-auto">
              Measuring our success through the preservation of traditions and
      ...
      <section id="heritage-cta" className="py-20 px-5 bg-dusky">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-white/90 text-lg mb-8 leading-relaxed">
            Join us in preserving Rwanda's rich heritage while creating new
